...
class Review(models.Model):
    ...
    :language (optional): Language shortcut to filter review.
...
class ReviewExtraInfo(models.Model):
    ...
    park review and you want to allow the user to select the weather
...
class RatingCategory(TranslatableModel):
    ...
    If your review are just text based, you don't have to use this.
